...
```bash
git clone https://github.com/2029-td/MUM_App_public.git
cd MUM_App_public
```
...
- 環境変数が必要な場合は，プロジェクトルートに .env を作成する（本リポジトリには含めない）．
...
本リポジトリは研究成果の再現性確保を目的として公開する．公開にあたり，鍵・アカウント情報等の機微情報は含めない．
